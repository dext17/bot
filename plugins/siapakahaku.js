...
let handler = async (m, { conn, usedPrefix }) => {
    global.kont = 'https://telegra.ph/file/3b8d4d2e00a84c7ce45b4.jpg'
...
Bonus: ${poin} XP🔖
    `.trim()
    conn.siapakahaku[id] = [
    await conn.sendButtonLoc(m.chat, await (await fetch(kont)).buffer(), caption, wm, 'Bantuan', usedPrefix + 'who', m),
    json,
    poin,
    setTimeout(() => {
