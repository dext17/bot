...
let handler = async (m, { conn, usedPrefix }) => {
    global.su = 'https://telegra.ph/file/257e0974bdd400bbe35db.jpg'
...
Bonus: ${poin} XP
    `.trim()
    conn.asahotak[id] = [
        await conn.sendButtonLoc(m.chat, await (await fetch(su)).buffer(), caption, wm, 'Bantuan', usedPrefix + 'ao', m),
        json, poin,
        setTimeout(async () => {
