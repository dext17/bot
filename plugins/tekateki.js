...
let handler = async (m, { conn, usedPrefix }) => {
    global.foto = 'https://telegra.ph/file/06a973e6dceed27c55724.jpg'
...
Poin: *${poin} XP* 🔖
    `.trim()
    conn.tekateki[id] = [
    await conn.sendButtonLoc(m.chat, await (await fetch(foto)).buffer(), caption, wm, 'Bantuan', usedPrefix + 'tete', m),
    json,
    poin,
    setTimeout(() => {
